...
\par{Apart from the force, there is also friction which is affecting the the term. Imagine a mass moving horizontally over a puddle of oil. The faster the mass moves, the greater the oil resists, and we say that Friction is \textbf{proportional to the speed}.}
\begin{align*}
