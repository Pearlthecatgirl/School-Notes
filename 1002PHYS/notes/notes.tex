...
\par{Limited to only a few substances, including iron and nickel. The strong interactions between the atomic magnetic dipole moments form magnetic domains on the piece of metal. Magnetic domains are regions that contain a lot of atoms whose magnetic moments all line up. Each region may have a different net magnetic moment but within each region all magnetic dipole moments are in the same direction. When a external magnetic force is applied, these magnetic dipole moments will all line up and form a net magnetic moment. If the field changes direction, then there is a torque generated which tries to force the material to the new direction. If the field is switched off, a hard ferromagnetic substance will keep that net magnetic dipole moment while soft ferromagnetic substances will lose them. Ferromagnetic materials can lose their ferromagnetic properties when they are heated, as the random thermal motions of the particles will disrupt the overall magnetic dipole. This occurs at the "curie temperature". A paramagnetic material is similar to ferromagnetic, except that it does not have magnetic domains, meaning that its magnetic interaction is weaker. }
