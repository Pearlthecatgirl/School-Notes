...
\par{A linear transformation is \textbf{determined} by its action on a \textbf{basis} of the domain. SUppose that $f:\mathbb{R}^{2}\to \mathbb{R}^{3}$ is a linear transfomration such that: \[
...
As a result, the range of a linera transformation $f:\mathbb{R}^{n}\to\mathbb{R}^{m}$ is the span of the images of any basis of $\mathbb{R}^{n}$
}
